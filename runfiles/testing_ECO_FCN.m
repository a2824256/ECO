...
fcn_params.nn_name = 'pascal-fcn8s-dag.mat';
fcn_params.compressed_dim = 47;
...
params.t_features = {
    ...
    struct('getFeature',@get_fcn_layers, 'fparams',fcn_params),...
...
params.min_image_sample_size = 500^2;   % Minimum area of image samples
params.max_image_sample_size = 500^2;   % Maximum area of image samples
...
params.proj_init_method = 'rand_uni';        % Method for initializing the projection matrix pca
